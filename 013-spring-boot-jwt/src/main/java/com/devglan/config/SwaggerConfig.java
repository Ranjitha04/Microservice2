...
public class SwaggerConfig {
    ...
    @Bean
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2).select().apis(RequestHandlerSelectors.basePackage("com.devglan")).paths(PathSelectors.any()).build().apiInfo(apiInfo())
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo("Product REST API", "Product API to perform CRUD opertations", "1.0", "Terms of service",
                new Contact("Developer", "www.springsecurity.com", "dev@gmail.com"), "License of API", "API license URL", Collections.emptyList());
    }
